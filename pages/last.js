	...
	return (
		<Layout footerBg='light'>
			<article>
				<article className='bg-[#d82a44] pt-52 pb-60'>
					<section className='max-w-screen-sm mx-auto text-center'>
						<div className='max-w-xl mx-auto text-white'>
							<h1 className='text-4xl font-bold'>About GT Groups</h1>
							<p className='text-xl leading-loose mt-8'>
					...
					<div className='flex items-center gap-x-5 max-w-screen-lg mx-auto'>
					...
					<div className='max-w-xl mx-auto mt-24'>
						<section className='bg-white bg-opacity-10 text-white p-16 text-center rounded-xl relative'>
							...
							<p className='text-xl text-white text-opacity-60 mt-10 leading-loose'>
					...
					<div className='max-w-screen-xl mx-auto text-white my-64 grid grid-cols-3 gap-10'>
					...
					<div className='max-w-screen-xl mx-auto grid grid-cols-2 text-white gap-x-24'>
						<section>
					...
					<section className='max-w-screen-sm mx-auto mt-44 text-center pb-10'>
						<h2 className='text-3xl font-bold text-white text-opacity-50'>
							Pioneer in Domestic & International Market
						</h2>
						<h1 className='text-6xl font-bold text-white mt-5'>for 50 Golden Years</h1>
					</section>
				</article>
				<div className='max-w-screen-lg w-full mx-auto mt-[-3.5rem] relative grid place-items-center'>
					<img src='/Gt_Website-29.png' className='w-auto h-[600px] absolute' alt='' />
				</div>
				...
				<section className='mt-36 mb-10 bg-gray-100 max-w-screen-xl mx-auto p-24 rounded-xl'>
					...
					<section className='base-grid auto-rows-[200px] mt-10'>
